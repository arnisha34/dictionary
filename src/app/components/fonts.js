...
export const Fonts = () => {
  ...
  return(
    <div id="fontOptions" className="text-md font-bold pr-5 self-center relative min-w-[175px]">
      <button type="button" id="current-font" className="flex justify-end cursor-pointer capitalize border-r-gray-300 border-r-1 w-full pr-5" onClick={handleClick}><span>{fontName}</span><ChevronDownIcon className="w-4 ml-4 text-sky-600"/></button>
